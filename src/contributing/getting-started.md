...
- If you want to tweak the configurations of mods or change/add basic items and recipes, you'll want to use our main repository, [SymmetricDevs/Supersymmetry](https://github.com/SymmetricDevs/Supersymmetry/). We'll comment more on how to set up this repository in the [main modpack section](./main-modpack-structure.md).
